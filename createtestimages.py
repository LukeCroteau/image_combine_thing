...
def write_image(color,text1,text2,foreground=''):
    background = Image.new('RGB', (250, 250), (250,250,250))
...
if __name__ == '__main__':
    colorlen = len(colors.keys())
    colorlist = list(colors.keys())
    for i in range(1001, 1101):
        color = colorlist[i % colorlen]
        image = write_image(colors[color], str(i), '')
